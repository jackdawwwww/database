...
public class ShopsInsertController implements InsertController, Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        TextField[] fields = { pointSize, rentPrice, communalPayments, countersNum, roomsNum };
