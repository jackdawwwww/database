...
public class UnivermagsInsertController implements InsertController, Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        TextField[] fields = { pointSize, rentPrice, communalPayments, countersNum, roomsNum, sectionsNum };
    ...
    public void setItem(String item) {
        ...
        String rooms = DatabaseManager.getSubstring(" rooms_count=", "rooms_count=", item);
        String sections = DatabaseManager.getSubstring(" sections_num=", "sections_num=", item);
        ...
        roomsNum.setText(rooms);
        sectionsNum.setText(sections);
    }
    ...
    private void insertButtonTapped() {
        if (nameField.getText().isEmpty() || pointSize.getText().isEmpty()) {
            ...
            String rooms = roomsNum.getText().isEmpty() ? "null" : roomsNum.getText();
            String sections = sectionsNum.getText().isEmpty() ? "null" : sectionsNum.getText();
